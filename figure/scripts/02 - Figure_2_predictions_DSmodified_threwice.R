...
figleg <- ggplot() +
  coord_cartesian(ylim = c(0, 1.95), xlim = c(-5, 4.5)) +
  theme(panel.border = element_blank(),
        ...
        plot.margin = margin(t = 5.5, r = 5.5, b = 10, l = 40, unit = "pt")) +
  annotate(geom = "text", x = 0, y = 1.9, label = "Invertebrate functional groups", size = 3, fontface = 2) +
  annotate(geom = "segment", x = -1.7, xend = -0.7, y = 1.55, yend = 1.55, size = 1, colour = "#007EB1") +
  annotate(geom = "segment", x = -1.7, xend = -0.7, y = 1.3, yend = 1.3, size = 1, colour = "#00888C") +
  annotate(geom = "segment", x = -1.7, xend = -0.7, y = 1.05, yend = 1.05, size = 1, colour = "#008859") +
  annotate(geom = "segment", x = 2.8, xend = 3.8, y = 1.55, yend = 1.55, size = 1, colour = "#607700") +
  annotate(geom = "segment", x = 2.8, xend = 3.8, y = 1.3, yend = 1.3, size = 1, colour = "#A95700") +
  annotate(geom = "segment", x = 2.8, xend = 3.8, y = 1.05, yend = 1.05, size = 1, colour = "#B94363") +
  ...
  annotate(geom = "text", x = 1.5, y = 1.55, label = "Piercer", size = 3) +
  annotate(geom = "text", x = 1.5, y = 1.3, label = "Scraper", size = 3) +
  annotate(geom = "text", x = 1.5, y = 1.05, label = "Shredder", size = 3) +
  annotate(geom = "text", x = 0, y = 0.65, label = "Stocks and fluxes", size = 3, fontface = 2) +
  annotate(geom = "segment", x = -1.5, xend = -0.5, y = 0.3, yend = 0.3, size = 1, colour = "#4D67C3") +
  annotate(geom = "segment", x = 3.5, xend = 4.5, y = 0.3, yend = 0.3, size = 1, colour = "#008200") +
  annotate(geom = "segment", x = 0.8, xend = 1.8, y = 0, yend = 0, size = 1, colour = "#8C6900") +
  annotate(geom = "text", x = -3.5, y = 0.3, label = "Bacterial density", size = 3) +
  annotate(geom = "text", x = 1.5, y = 0.3, label = "CO[2]~concentration", size = 3, parse = TRUE) +
  annotate(geom = "text", x = -1.3, y = 0, label = "Nitrogen uptake", size = 3)
figleg

# saving plots ------------------------------------------------------------------------------------------

ggsave(filename = "figure/figures/Figure_2_Nicholas_tweak_opt2.png", 
